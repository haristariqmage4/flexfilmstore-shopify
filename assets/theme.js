  ...
  theme.AjaxProduct = (function() {
    ...
    ProductForm.prototype = Object.assign({}, ProductForm.prototype, {
      addItemFromForm: function(evt, callback){
        ...
        var isSample = this.form.isSample.value;
        var currentShadeValue = this.form.id.selectedOptions[0].getAttribute('data-title');
        var isSameSampleInCart = this.form.isSameSampleInCart.value;
        var cartSampleShadeValue = this.form.cartSampleShadeValue.value;
         var cartSampleShadeValueCheck = this.form.cartSampleShadeValueCheck.value;
        
  // rekha alert("hi"+this.form.cartSampleShadeValue.value+"form"+this.form.id.selectedOptions[0].getAttribute('data-title'));
        if(isSample == 'yes'){
          if(isSameSampleInCart == 'yes'){
            if(cartSampleShadeValueCheck == 'yes' && cartSampleShadeValue.includes(currentShadeValue) == true )
            {
              document.getElementById('maxtext').innerHTML="You've reached the maximum quantity of samples you can purchase.<br/>";
              document.getElementById('maxtext').style="display:block";
              document.getElementById('adcbtn').disabled = true;
              return;
            }
            else if(cartSampleShadeValueCheck == 'no' ){
              document.getElementById('maxtext').innerHTML="You've reached the maximum quantity of samples you can purchase.<br/>";
              document.getElementById('maxtext').style="display:block";
              document.getElementById('adcbtn').disabled = true;
              return;
  ...
  theme.Product = (function() {
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      updateCartButton: function(evt) {
        ...
        if (variant) { //alert(variant.title);
